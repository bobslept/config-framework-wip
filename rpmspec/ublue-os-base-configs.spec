...
%attr(0644,root,root) %{_datadir}/%{VENDOR}/%{sub_name}/%{_exec_prefix}/usr/lib/systemd/system/fprintd.service
%attr(0644,root,root) %{_datadir}/%{VENDOR}/%{sub_name}/%{_exec_prefix}/etc/tlp.d/50-framework.conf
%attr(0644,root,root) %{_exec_prefix}/usr/lib/systemd/system/fprintd.service
